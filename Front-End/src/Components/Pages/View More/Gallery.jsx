...
const galleryImages = [
  ...
  { src: img3, alt: 'Image 3', type: 'prtrait' },
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      items.forEach((item, index) => {
        ...
        const screenPosition = window.innerHeight / 1.2; // Trigger a bit earlier
    ...
    // Trigger once on component mount for initial visibility
    handleScroll();
