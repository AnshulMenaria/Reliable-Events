        ...
        <Row className="align-items-center justify-content-between">
          ...
          <Col xs={6} md={2} className="footer-socials-wrapper mt-4 mt-md-0">
            ...
            <ul className="footer-socials">
              <li><a href="https://www.instagram.com/reliable_events_udaipur" target="_blank" rel="noreferrer"><i className="fab fa-instagram"></i> Instagram</a></li>
              <li><a href="https://www.facebook.com/share/KTMr6F5EmFgrdHYh/?mibextid=LQQJ4d" target="_blank" rel="noreferrer"><i className="fab fa-facebook-f"></i> Facebook</a></li>
              <li><a href="https://wa.me/6378394687" target="_blank" rel="noreferrer"><i className="fab fa-whatsapp"></i> WhatsApp</a></li>
            </ul>
          </Col>
          ...
          <Col xs={6} md={3} className="footer-contact-wrapper mt-4 mt-md-0">
            ...
            <p><a href="tel:+918005754631">+91 8005754631</a></p>
            <p><a href="tel:+916378394687">+91 6378394687</a></p>
            <p><a href="mailto:reliableeventsudaipur@gmail.com">reliableeventsudaipur@gmail.com</a></p>
          </Col>
